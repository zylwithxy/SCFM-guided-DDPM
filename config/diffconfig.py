...
def get_model_conf():
    ...
    use_warp=True,
    flownet_attnlayer= [3, 4, 5],
    use_warp_separate=False,
    use_attention_qkv = False, 
    ablation_pose_target_wo_target_enc = False,
    enable_architecture_remove = True, # for removing input_blocks and output_blocks about nonres blocks
    enable_source_enc_remove = False,  # for removing source encoder blocks
    enable_archi_inres_remove = False, # for removing input_blocks and output_blocks about inres(32, 16, 8) blocks
    enable_source_enc_inres_remove = False, # for removing source encoder blocks for inres(32, 16, 8) blocks
    use_cct = True,
    cct_pos = 'input_blocks',
    use_flowdisp = True,
    )
